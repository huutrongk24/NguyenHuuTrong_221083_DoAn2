...
namespace QLHieuSuat.Controllers
{
    public class PhongBansController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,TenPhongBan")] PhongBan phongBan)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TenPhongBan")] PhongBan phongBan)
        {
            if (id != phongBan.Id)
            {
                return NotFound();
